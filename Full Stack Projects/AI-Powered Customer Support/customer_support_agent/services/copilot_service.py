"""
SupportCopilot — the core agent that generates draft replies for support tickets.

Uses a LangChain agent backed by Groq LLM, enriched with:
- Mem0-based per-customer and per-company memory
- ChromaDB knowledge-base retrieval (RAG)
- Support tools (billing lookup, plan checks, etc.)
"""
